 ...
 * Realiza la accion de atacar de un barbaro, usando dados de 8 y de 20, y utilizando la fuerza del atacante.
	...
	public void ataque(Enemigo enem, Jugador player, int n) {
		...
		if(n == 0){
			...
			if (veinte >= enem.getArmor()){
				...
				damage = ocho + player.getStr();
				System.out.println( player.getName() +" ataca con "+ damage + " de danio" );
				if(tru == 20) {
